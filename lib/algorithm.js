...
function resolveCandidateTree(repository, rootPackage, currentSolution, remainingToSelect) {
  ...
  for (var i = 0; i < depNames.length; i++) {
    ...
    for (var j = 0; j < versions.length; j++) {
      ...
      try {
        return resolveCandidateTree(repository, repository.get(dep, version), newSolution, newRemaining);
      } catch (e) {
...
exports.doFlatten = function(repository, rootPackage) {
  return resolveCandidateTree(repository, rootPackage, {}, {});
};